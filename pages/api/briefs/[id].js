...
export default async function handler(req, res) {
  ...
  try {
    if (req.method === 'PUT') {
      ...
      const updated = await updateBrief(id, { tglMasuk, pilar, platform, brief, status, tglSelesai, hasilAkhir, referensi, tglPosting, deskripsiBrief, isReference: isReference ? String(isReference) : 'false' });
