...
// Urutan kolom di sheet HARUS sama seperti urutan ini (kolom A - K)
const HEADERS = ['id', 'tglMasuk', 'pilar', 'platform', 'brief', 'status', 'tglSelesai', 'hasilAkhir', 'tglPosting', 'deskripsiBrief', 'isReference'];
const LAST_COL = 'K';
