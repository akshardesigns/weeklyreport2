...
// Urutan kolom di sheet HARUS sama seperti urutan ini (kolom A - L)
const HEADERS = ['id', 'tglMasuk', 'pilar', 'platform', 'brief', 'status', 'tglSelesai', 'hasilAkhir', 'tglPosting', 'deskripsiBrief', 'isReference', 'referensi'];
const LAST_COL = 'L';
